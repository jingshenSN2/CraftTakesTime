...
public class CraftContainers {
    ...
    private CraftContainers() {
        registerCraftContainer(CraftContainerProperties.builder()
                ...
                .guiContainerClassName("net.minecraft.client.gui.screen.inventory.InventoryScreen")
        ...
        registerCraftContainer(CraftContainerProperties.builder()
                ...
                .guiContainerClassName("net.minecraft.client.gui.screen.inventory.CraftingScreen")
                .build());
